...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php $post_id = get_the_ID();
		if (get_video_thumbnail($post_id)) {?>
		<div class="entry-thumb">
			<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><img src="<?php echo video_thumbnail() ?>"></a>
		</div>
	<?php } else if (has_post_thumbnail() && ( get_theme_mod( 'index_feat_image' ) != 1 )) { ?>
		<div class="entry-thumb">
